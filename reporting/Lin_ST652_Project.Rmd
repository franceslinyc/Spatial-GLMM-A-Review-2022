...
Assume $M$ to be a matrix that contains the first $q \ll n$ eigenvectors of the Moran operator. Further assume $\lambda_q > 0$ since neighboring observations tend to be similar, rather than dissimilar, in practice. As a result, at least half of the eigenvectors can be discarded, making it possible to achieve a much greater dimension reduction. 
