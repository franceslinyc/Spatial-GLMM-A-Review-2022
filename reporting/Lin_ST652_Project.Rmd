...
Here, it has been shown that (Boots & Tiefelsdorf, 2000) 

(a) the (standardized) spectrum of a Moran operatore comprises the possible values for the corresponding $I_X(A)$ and 
