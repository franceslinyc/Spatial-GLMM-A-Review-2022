...
3. Update 
    ...
    - Take ratio of the likelihood (or difference of the log-likelihood) for $j+1$ and $j$ and set it to $\alpha$ acceptance ratio 

4. Generate $u \sim Unif(0,1)$ and if $u \leq \alpha$, then accept it as the next step $j+1$ and update $\delta_S$ and $\tau$. Otherwise, stay at the current step $j$. 
